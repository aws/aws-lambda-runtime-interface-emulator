...
// go test -run=XXX -bench=. -benchtime 10000000x -cpu 1 -blockprofile /tmp/pprof/block3.out src/github.com/aws/aws-lambda-runtime-interface-emulator/internal/lambda/core/*
// goos: linux
// goarch: amd64
